...
def main(interval_seconds: int = 300, ui_port: Optional[int] = None) -> int:
    ...
    ui_port :
        ...
        ``legacy.streamlit_command_center.desktop_shell.net_util.find_free_port()``.
    ...
    # sys.modules['legacy.streamlit_command_center.desktop_shell.net_util'] / etc. BEFORE these names are resolved.
    from legacy.streamlit_command_center.desktop_shell.net_util import find_free_port, wait_for_http
    from legacy.streamlit_command_center.desktop_shell.ui_server import start_ui_server, stop_ui_server
    from legacy.streamlit_command_center.desktop_shell.engine_supervisor import start_engine, stop_engine
