"""InvestYo Command Center — Settings Manager tab. Edits the allowlisted non-secret tunables through shared.env_io (secrets are masked and never writable); changes take effect on the next launch."""
...
_SETTINGS_LAYOUT: List[tuple[str, str]] = [
    ...
    ("SYMBOL_RATING_BAD_SCORE_THRESHOLD", "number"),
    ("SYMBOL_RATING_AUTO_DROP_ENABLED", "bool"),
    ("SYMBOL_RATING_DROP_THRESHOLD_CYCLES", "int"),
