...
3.  **Daily briefings**          — ``OUTPUT_DIR/briefing_*.md`` (+ a
    "Generate today's briefing" button when ``shared.command_runner`` is present)
...
from legacy.streamlit_command_center.panels._shared import _REPO_ROOT, list_report_files, logger
