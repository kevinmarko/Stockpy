...
gravity/__init__.py
===================
GravityAIAuditor class and supporting utilities, extracted from the top-level
``Gravity AI Review Suite.py`` launcher (Phase 4b, 2026-06-29).

External callers that previously ran the suite as a subprocess continue to use
the launcher file unchanged.  Code that needs the class directly can now do::
