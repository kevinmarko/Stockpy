...
# GICS_SECTORS / _BF_EDITOR_COLUMNS used to live in
# legacy.streamlit_command_center.panels._shared and be imported back here
# lazily, to dodge a circular import (that package's __init__ imports
# report_viewer, which imports this module). Now that this module lives in
# shared/ — outside the archived Streamlit UI entirely — they're defined
# natively here instead, and legacy.streamlit_command_center.panels._shared
# re-exports them from here (reversed from the old direction).
