...
The Streamlit-facing wiring lives in :func:`legacy.streamlit_command_center.panels.render_gravity_audit`.
...
:mod:`shared.llm_commentary_panel`, :mod:`shared.circuit_breakers`, and
:mod:`shared.observability_telemetry`.
