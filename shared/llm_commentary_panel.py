...
The Streamlit-facing wiring lives in :func:`legacy.streamlit_command_center.panels.render_report_viewer`.
...
:mod:`shared.circuit_breakers`, :mod:`shared.observability_telemetry`, and
:mod:`shared.market_data_diagnostics`.
