...
The Streamlit-facing wiring lives in :func:`legacy.streamlit_command_center.panels.render_ai_insights`.
This module hosts the pure helpers it depends on so they remain unit-
testable headlessly — mirrors the pattern used by
:mod:`shared.llm_commentary_panel` and :mod:`shared.gravity_ai_panel`.
