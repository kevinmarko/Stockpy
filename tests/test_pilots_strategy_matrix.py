...
@pytest.mark.parametrize(
    "module_name",
    ["strategy_matrix", "options", "strategy_health", "commands", "agentic", "discovery", "scan_config_store", "watchlist_writer", "validation_trend", "gravity_audit", "sector_selection", "reports", "dead_letter"],
)
def test_pilots_read_helpers_stay_dependency_light(module_name):
    ...
    if module_name == "reports":
        ...
        # else (json for validation-summary parsing, math for the recursive
