...
class TestTunablesScopeInvariants:
    def test_every_served_key_is_allowlisted_non_secret(self):
        ...
        expected = {"SIZING_CAP_ESCALATION_THRESHOLD_CYCLES", "VOL_TARGET", "MARKET_DATA_BARS_TTL_SECONDS", "FORECAST_MODEL_PERSISTENCE_ENABLED", "PIT_CAPTURE_ENABLED", "META_LABELING_ENABLED", "PILOTS_API_ENABLED", "RISK_FREE_RATE", "MARKET_RISK_PREMIUM", "REQUIRED_RETURN_RATE", "RLHF_CALIBRATION_AUTO_EXPORT_SFT_ENABLED", "HMM_RISK_OFF_BLOCK_THRESHOLD", "MAX_PORTFOLIO_HEAT", "CNN_LSTM_SUBPROCESS_TIMEOUT_SECONDS", "DRY_RUN", "BERT_LLA_ABLATION_ENABLED", "QDRANT_COLLECTION", "BERT_LLA_BLEND_ENABLED", "BETA_LOOKBACK_DAYS", "NEWS_HISTORY_CAPTURE_ENABLED", "FORECAST_PROPHET_WEIGHT", "PROGRESS_POLL_SECONDS", "CNN_LSTM_SUBPROCESS_ISOLATION_ENABLED", "EXECUTION_QUEUE_LEAK_RATE_PER_SEC", "SIZING_CAP_ESCALATION_ENABLED", "DUAL_MOMENTUM_SAFE_ASSET", "DUAL_MOMENTUM_RISKY_ASSETS", "SENTIMENT_AUDIT_ENABLED", "EXCURSION_INTRADAY_ENABLED", "FORECAST_SKILL_WINDOW_DAYS", "FORECAST_USE_GARCH_SIGMA", "RLHF_CALIBRATION_CONFIDENCE_THRESHOLD", "CORS_ALLOWED_ORIGINS", "KELLY_CAP", "MAX_LEVERAGE", "MARKET_DATA_WS_ENABLED", "FORECAST_CNN_LSTM_WALKFORWARD_SCALING", "FORECAST_SKILL_WEIGHTING_ENABLED", "OPTIONS_MATRIX_ENABLED", "GRAVITY_REQUIRE_NATIVE", "MAX_ORDER_RATE_PER_MIN", "CNN_LSTM_PROCESS_POOL_WORKERS", "MARKET_DATA_PROVIDER", "DAILY_LOSS_LIMIT_PCT", "SIZING_CAP_ALERT_ENABLED", "PROMPT_REGISTRY_ENABLED", "DASHBOARD_REFRESH_SECONDS", "QDRANT_URL", "BERT_LLA_WINDOW_SIZE", "ADVISORY_REUSE_PIPELINE_COMPUTE", "ADVISORY_ONLY", "SIZING_CAP_ALERT_THRESHOLD_PCT", "OPTIONS_TRUE_IVR_ENABLED", "BERT_LLA_ENABLED", "LOG_LEVEL", "EXECUTION_PRIORITY_QUEUE_ENABLED", "PAIRS_SNAPSHOT_ENABLED", "MAX_PORTFOLIO_GROSS", "USE_DUAL_MOMENTUM_OVERLAY", "SECTOR_FORECAST_CONFIG_PATH", "VALIDATION_HARNESS_OOS_GATE_ENABLED", "SECTOR_FORECAST_CONFIGS", "MARKET_DATA_QUOTE_TTL_SECONDS", "RLHF_CALIBRATION_AUTO_APPROVE_ENABLED", "SIZING_CAP_AUDIT_ENABLED", "FORECAST_MODEL_RETRAIN_DAYS", "FLATTEN_ON_KILL", "MAX_POSITION_WEIGHT", "BERT_LLA_MIN_SENTIMENT_COVERAGE", "KELLY_FRACTION", "FUNDAMENTALS_SOURCE", "SENTIMENT_DESENTENCIZE_ENABLED", "RISK_GATE_ENFORCE_MARKET_HOURS", "MAX_CORRELATION", "META_LABEL_MIN_CONFIDENCE", "SIZING_CAP_ESCALATION_FACTOR", "ROBINHOOD_AUTO_REFRESH_ENABLED", "HISTORICAL_STORE_ENABLED", "ORCHESTRATOR_DAEMON_ENABLED", "PROMPT_REGISTRY_BACKEND"}
