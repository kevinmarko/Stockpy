"""Freshness gate: the committed manifest's strategy_registry must match
scripts.refresh_validations.STRATEGY_REGISTRY exactly.
...
from STRATEGY_REGISTRY without regenerating the manifest, the webapp silently
drifts out of sync -- this test catches both directions of that drift.
"""
