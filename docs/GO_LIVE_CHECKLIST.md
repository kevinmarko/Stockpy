...
- [ ] `FRED_API_KEY` rotated within the last **90 days**.  
  ...
  (`check_fred_key_rotation_recent` — wired in Stage 3 of the 2026-06-26 cleanup plan).
- [ ] `ALPACA_API_KEY` + `ALPACA_SECRET_KEY` rotated within the last **90 days**.  
  ...
  (`check_alpaca_key_rotation_recent` — wired in Stage 3 of the 2026-06-26 cleanup plan).
