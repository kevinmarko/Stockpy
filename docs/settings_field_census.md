...
- Measured at commit: `619d2a72f89eab73bff9bd9a0c6beb01135fcd4e`
...
| `GCLOUD_BIN` | L4133 | **no** | Path to the gcloud binary for environment integrations. |
...
| `GRAVITY_REQUIRE_NATIVE` | L4137 | **no** | Require native implementation for Gravity Review Suite. |
...
| `QDRANT_COLLECTION` | L4141 | **no** | Qdrant collection name for RAG orchestrator. |
| `QDRANT_URL` | L4145 | **no** | Qdrant URL for RAG orchestrator. |
...
| `WATCHLIST` | L4129 | **no** | Comma-separated list of symbols to always include in the universe. |
...
Fields reached by at least one form: **324** of 333.
