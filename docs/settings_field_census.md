...
- Measured at commit: `c646d9199172df9d3dd0cc33f1ebfb56824e25ce`
...
Scope: **444** production `.py` files (excludes `tests/`, `test_*.py`, `conftest.py`, `.venv/`, `webapp/`, `node_modules/`).
