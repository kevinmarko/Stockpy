...
Scope: **386** production `.py` files (excludes `tests/`, `test_*.py`, `conftest.py`, `.venv/`, `webapp/`, `node_modules/`).
...
| `PROMPT_REGISTRY_REFRESH_SECONDS` | `Gravity AI Review Suite.py:11000` | likely read dynamically |
