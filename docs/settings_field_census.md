...
- Measured at commit: `0fa56f7d7461480872e9c860db3861cd229e6667`
...
Scope: **428** production `.py` files (excludes `tests/`, `test_*.py`, `conftest.py`, `.venv/`, `webapp/`, `node_modules/`).
