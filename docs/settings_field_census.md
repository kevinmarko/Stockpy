...
|---|---|---|---|
| `ALLOWED_KEYS` | 348 | 348 | 0 duplicate entries (clean) |
...
| `IN_ALLOWED_KEYS` | 348 | in `env_io.ALLOWED_KEYS` |
...
Fields reached by at least one form: **391** of 400.
...
### Fields reachable ONLY via form (b) or (d), never via (a) — **159**
