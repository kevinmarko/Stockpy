...
- **`vrp_premium_selling`**: In `validation/options_selling_backtest.py`, added SPY > SMA-200 market trend filter preventing premium selling (Iron Condors / Put Credit Spreads) during structural bear markets. This completely eliminated the catastrophic April 2022 loss where short puts were sold into an active downtrend.
