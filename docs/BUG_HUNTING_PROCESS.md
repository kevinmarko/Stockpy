...
4. **Pytest Verification**: Full suite in comprehensive mode; targeted suite in quick mode (`test_help_content`, `test_dto_models`, `test_quantitative_models` lookahead perturbation, `test_bug_hunter` self-test).
